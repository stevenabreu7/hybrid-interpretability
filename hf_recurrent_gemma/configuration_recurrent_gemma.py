...
class RecurrentGemmaConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        topk_heads:int = None, #DZ
        sparsity_metric = None,
        sparsity_prefill = None,
        manipulated_heads:List = None, #attention manipulation
        attention_value:List = None, #attention manipulation
        vocab_size=256000,
        hidden_size=2560,
        ...
        **kwargs,
        ...
        self.sparsity_prefill = sparsity_prefill
        self.num_heads = num_attention_heads #DZ
        self.manipulated_heads = manipulated_heads #attention manipulation
        self.attention_value = attention_value #attention manipulation
